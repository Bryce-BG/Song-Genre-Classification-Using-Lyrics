...
"""
A script that calls the sklearn's implementation of the decisiontree algorithm on our dataset to train the feature vector wieghts for our dataset. 
...
def main():
    ...
    classifier = tree.DecisionTreeClassifier()  # create instance of the perceptron
