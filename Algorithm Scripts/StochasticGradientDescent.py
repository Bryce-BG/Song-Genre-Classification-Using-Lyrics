...
def main():
    ...
    classifier = linear_model.SGDClassifier()  # create instance of the perceptron
    classifier.n_iter = 20  # number ot times to itterate

    # classifier = linear_model.Perceptron(penalty = None, alpha = 0.0001, fit_intercept = True, max_iter = 1, tol = None, shuffle = True, verbose = 0, eta0 = 1.0, n_jobs = 1, random_state = 0, class_weight = None, warm_start = False, n_iter = None)
